...
"Calibri Light",sans-serif'>{{$client->FullName}}</span></p>
...
11.0pt;line-height:150%;font-family:"Calibri Light",sans-serif'>{{$client->dob}} года рождения, Паспорт серия {{$client->passport_series}} № {{$client->passport_number}} </span></p>

<p class=MsoNormal style='line-height:150%'><span lang=RU style='font-size:
11.0pt;line-height:150%;font-family:"Calibri Light",sans-serif'>{{$client->passport_d_issue}} года, адрес {{$client['address'][0]['FullAddress']}}
</span></p>
...
{{$client->phone_number}}                </span><span style='font-size:11.0pt;
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0 width=738
 ...
 <tr style='height:100.9pt'>
  ...
  style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>&nbsp;</span></p>
  <p class=MsoBodyText style='margin-left:.25in'><span lang=RU
  style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>Фамилия: {{$client['surname']}}</span></p>
  <p class=MsoBodyText><span lang=RU style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>&nbsp;</span></p>
  <p class=MsoBodyText style='margin-left:.25in'><span lang=RU
  style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>Имя {{$client['name']}}</span></p>
  <p class=MsoBodyText><span lang=RU style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>&nbsp;</span></p>
  <p class=MsoBodyText style='margin-left:.25in'><span lang=RU
  style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>Отчество {{$client['patronymic']}}</span></p>
  <p class=MsoBodyText><span lang=RU style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>&nbsp;</span></p>
  <p class=MsoBodyText><span lang=RU style='font-size:10.0pt;font-family:"Calibri Light",sans-serif'>&nbsp;</span></p>
  <p class=MsoBodyText style='margin-left:.25in'><span lang=RU
