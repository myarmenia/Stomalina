...
<head>
    ...
    <title>Стомалина</title>
     <link rel="shortcut icon" type="image/png" href="{{ asset('images/Group1169.png') }}">
</head>
<body>
    <!-- <div class="icon_0003">-->
...
<div class="footer" id="contact_id">
            ...
            <div class="footer_box footer_box_2">
                ...
                <a>
                    <p>Последний вагон из центра,выход из метро направо.</p>
                </a>
                <a >
                    <p>
...
<!--    </div>-->
<!--</div>-->
<footer class="footer002">
        <p class="footer002_text">Стоматология Стомалина ООО"Блеск-Л" Лицензия ЛО-77-01-011125</p>
        <div class="icone002">
            <a href="https://vk.com/stomalina"> <img src="{{asset('images/vk.png')}}" alt=""></a>
            <a href="https://ok.ru/stomalina"><img src="{{asset('images/ok.png')}}" alt=""></a>
        </div>
    </footer>
